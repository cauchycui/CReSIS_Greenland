...
%roughness values offset perpendicularly from the tracks as text files. The 
%function has up to eleven optional inputs: filename, tracks, roughness 
%value processing ('values', 'sqrt', or 'log'), title ('default' maintains
%default titling and 'image' creates a PostScript image and text file with 
%parameters), scale factor, boundaries, offset color, jump color, track
