# -*- coding: utf-8 -*-
#function  [x,y,utmzone] = deg2utm(Lat,Lon,Huso_in)
# -------------------------------------------------------------------------
# Huso_in input added by R. Ian Crocker on 24 Nov 2009
# Huse_in input will force a specific UTM zone. Not sure how fool proof it is. Works for Svalbard zone 32 X data though
# 
...
# Argument checking
#
#error(nargchk(2, 3, nargin));  #2 or 3 arguments required. changed by R. Ian Crocker on 24 Nov 2009
#n1=length(Lat);
#n2=length(Lon);
#if (n1~=n2)
